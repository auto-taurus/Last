...
namespace Gbxx.WebApi.Areas.v1.Controllers {
    ...
    public class SiteController : ControllerBase {
        ...
        public async Task<IActionResult> GetWebSiteAsync(string mark, [FromQuery]GetBase args) {
        ...
        /// <returns></returns>
        [HttpGet("{mark}/Access")]
        public async Task<IActionResult> GetSiteAccessAsync(string mark, [FromQuery]GetSiteAccess args) {
