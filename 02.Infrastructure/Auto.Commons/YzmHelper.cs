...
namespace Auto.Commons {
    ...
    public class YzmHelper {
        ...
        private Font[] fonts = {new Font(new FontFamily("Times New Roman"),14 +Next(1),System.Drawing.FontStyle.Bold),
                                new Font(new FontFamily("Georgia"), 14 + Next(1),System.Drawing.FontStyle.Bold),
                                new Font(new FontFamily("Arial"), 14 + Next(1),System.Drawing.FontStyle.Bold),
                                new Font(new FontFamily("Comic Sans MS"), 14 + Next(1),System.Drawing.FontStyle.Bold)
                                };
        #endregion
        #region 公有属性
        /// <summary>
        ...
        public YzmHelper(RandType type, int number, int width, int height) {
            if (width > 0) this.letterWidth = width;
            if (height > 0) this.letterHeight = height;
            SetRandType(type, number);
        }
        #endregion
        #region 私有方法
        ...
        public byte[] CreateBinary() {
            ...
            this.Image.Save(ms, ImageFormat.Gif);
            return ms.GetBuffer();
        }
