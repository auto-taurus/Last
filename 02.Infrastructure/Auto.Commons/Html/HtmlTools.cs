using Auto.Commons.RandomSelector;
using Ganss.XSS;
...
namespace Auto.Commons.Html {
    ...
    public static partial class HtmlTools {
        ...
        public static string MatchRandomImgSrc(this string html) {
            ...
            var rnd = new Random();
            return srcs.Count > 0 ? srcs[rnd.Next(srcs.Count)] : "";
        }
        ...
        public static string MatchSeqRandomImgSrc(this string html) {
            var srcs = MatchImgSrcs(html).ToList();
            return srcs.Count > 0 ? srcs.Select((s, i) => new WeightedItem<string>(s, srcs.Count - i)).WeightedItem() : "";
        }
